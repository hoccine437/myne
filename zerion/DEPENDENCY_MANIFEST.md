...
```json
{
  ...
  "environment_variables_documented": [
    ...
    "AUTOPILOT_ENABLED", "COMM_SHADOW_DEFAULT", "COMM_REQUIRE_FLOW",
    "COMM_FLOW_TTL", "SERIOUS_MAX_ATTEMPTS", "SERIOUS_LOCKOUT_S",
    "PLANNER_MODE", "ZERION_MAX_RSS_MB", "ZERION_AGENT_REAP_EVERY",
    "THINKING_MODE", "THINKING_MULTIPLIER", "ZERION_LIVE_LLM_CHECK"
  ],
